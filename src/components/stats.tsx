...
const Stats: React.FC = () => {
  const { error, userData } = useGithubStats('Ashurumaru');
  ...
  const renderStatCards = (
    stats: { value: number; label: string; IconComponent: IconType }[],
  ) =>
    ...
    <section className="container mx-auto p-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[80vw] mx-auto sm:max-w-none text-center">
        {renderStatCards([
          ...
          {
            value: STATIC_STATS.completedProjects,
            label: 'Completed Projects',
            IconComponent: FaCheckCircle,
          },
          {
            value: STATIC_STATS.knownTechnologies,
            label: 'Known Technologies',
            IconComponent: FaLaptopCode,
          },
          {
            value: STATIC_STATS.hackathonsParticipated,
            label: 'Hackathons Participated',
            IconComponent: FaTrophy,
          },
          {
            value: STATIC_STATS.mangasRead,
            label: 'Mangas Read',
            IconComponent: FaBook,
          },
          {
            value: STATIC_STATS.animesWatched,
            label: 'Animes Watched',
            IconComponent: FaTv,
          },
          {
            value: STATIC_STATS.apexHours,
            label: 'Hours in Apex Legends',
